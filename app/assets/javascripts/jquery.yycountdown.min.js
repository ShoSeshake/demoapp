...
(function(b) {
    b.fn.yycountdown = function(f) {
        var a = b.extend({ startDateTime: new Date, endDateTime: "2020/07/24 00:00:00", diffDateTime: 0, unit: { d: "day", h: "hour", m: "min", s: "sec" }, complete: null, node: { d: null, h: null, m: null, s: null }, self: null, timerId: null }, f);
        a.self = b(this);
        (function() {
